    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800 leading-tight flex items-center gap-2">
                <i data-lucide="edit" class="h-6 w-6 text-gray-600"></i>
                {{ __('Edit Hostel') }}
            </h2>
        </div>
    </x-slot>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea name="description" 
                                          id="description" 
                                          rows="4"
                                          class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('description', $hostel->description) }}</textarea>
                            </div>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-2 text-xs text-gray-500">
                                    Upload a new photo to replace the existing one. Maximum file size: 2MB. Supported formats: JPEG, PNG, JPG.
                                </p>
                            </div>
                        </div>
                        @error('photo')
