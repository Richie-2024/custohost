                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                      <div class="flex items-center justify-center gap-4">
                          ...
                          @if($booking->status === 'pending')
                              <!-- Approve Button -->
                              <form action="#" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to approve this booking?');">
                                  @csrf
                              ...
                              <!-- Reject Button -->
                              <form action="#" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to reject this booking?');">
                                  @csrf
                          ...
                          @elseif($booking->status === 'active' || $booking->status === 'completed' || $booking->status === 'confirmed')
                              <!-- Cancel Button -->
