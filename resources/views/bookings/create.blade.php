    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-gray-800 leading-tight flex items-center gap-2">
                <i data-lucide="calendar-plus" class="h-6 w-6 text-gray-600"></i>
                {{ __('Book a Room') }}
            </h2>
        </div>
    </x-slot>
            ...
            <form action="{{ route('bookings.store') }}" method="POST">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <textarea name="special_requests" 
                                          id="special_requests" 
                                          rows="3"
                                          class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('special_requests') }}</textarea>
                            </div>
                ...
                <div class="p-6 border-b border-gray-200 bg-gray-50">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center gap-2 mb-4">
                        <i data-lucide="calculator" class="h-5 w-5 text-gray-500"></i>
                        Price Summary
                    </h3>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePriceSummary() {
                ...
                if (checkInDate.value && checkOutDate.value) {
                    ...
                    totalAmountSpan.textContent = (roomPrice * months).toFixed(2);
                }
            }
