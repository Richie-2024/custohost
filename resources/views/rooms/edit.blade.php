                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <select name="type" 
                                    ...
                                    <option value="quad" {{ old('type', $room->type) == 'quad' ? 'selected' : '' }}>Quad</option>
                                </select>
                            </div>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea name="description" 
                                          id="description" 
                                          rows="3"
                                          class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('description', $room->description) }}</textarea>
                            </div>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
