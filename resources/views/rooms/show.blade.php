        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm text-gray-900">₹{{ number_format($room->price, 2) }} per month</p>
                            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 flex items-center gap-2 mb-4">
                            <i data-lucide="zap" class="h-5 w-5 text-gray-500"></i>
                            Quick Actions
                        </h3>
                                    ...
                                    <button type="submit" 
                                        ...
                                        <div class="flex items-center gap-3">
                                            <div class="bg-yellow-100 rounded-lg p-2 group-hover:bg-yellow-200 transition-colors">
                                                <i data-lucide="tool" class="h-5 w-5 text-yellow-600"></i>
                                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            @empty
                                <div class="text-center py-4">
                                    <p class="text-sm text-gray-500">No booking history</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
